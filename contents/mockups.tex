\chapter{Mockups}
This chapter contains mockups of Kwetterprise.
...
\section{Moderation}
A page for users with the role of moderator. Moderators can see a list of users and their roles. They can remove users who spread insulting tweets or use swear words. In addition, moderators can change the role of other users to moderator.
